...
public class CMGenoAlimentoDTO {
    ...
    public CMGenoAlimentoDTO() {
    }

    public CMGenoAlimentoDTO(Integer idCMCatalogoAlimento, Integer idCMCatalogo, String nombre, String descripcion,
            String estado, String fechaCreacion, String fechaModifica) {
        this.IdCMCatalogoAlimento = idCMCatalogoAlimento;
